...
// module.exports = __toCommonJS(generic_exports); // Commented out for browser use
...
if (typeof window !== 'undefined' && window.VercelAnalytics && typeof window.VercelAnalytics.inject === 'function') {
